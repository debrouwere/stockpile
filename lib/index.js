(function() {
  var FileCache, cached_proxy, crypto, express, filecache, fs, mime, request;
  ...
  cached_proxy = function(req, res) {
    ...
    return filecache.get(url, function(errors, file) {
      var contentType;
  ...
  exports.servers.libs.get('*', function(req, res) {
    ...
    if ((_base = req.query).url == null) _base.url = url;
